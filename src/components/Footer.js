...
const Footer = () => {
  ...
  return (
    <footer className="relative text-white py-12 overflow-hidden"> 
      ...
      {/* Dark Overlay */}
      <div className="absolute top-0 left-0 w-full h-full bg-black bg-opacity-50 z-0"></div> {/* Adjust opacity */}

      {/* Original Content Container - Positioned above overlay */}
      <div className="relative z-10 container mx-auto px-4">
         <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
           {/* Company Info */}
           <div>
             <h3 className='text-xl font-bold mb-4'>InteriorDesign</h3>
             <p className='text-gray-400 mb-4'>
               Creating beautiful, functional spaces that reflect your unique
               style and needs.
             </p>
             {/* Add Social Icons back here if needed */}
           ...
           <div>
             ...
             <ul className='space-y-2 text-gray-400'>
               <li className='flex items-start'>
                 ...
                 <span>123 Design Street, Creative City, 90210</span>
               </li>
               <li className='flex items-start'>
                 <svg
                   xmlns='http://www.w3.org/2000/svg'
         ...
         <div className='border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center'>
           <p className='text-gray-400 text-sm mb-4 md:mb-0'>
             &copy; {new Date().getFullYear()} InteriorDesign. All rights
             reserved.
           </p>
